...
{
	public class GreaterManaSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.GreaterManaPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Greater Mana Seeds");
      Tooltip.SetDefault("");
    }
