...
{
	public class LesserManaSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.LesserManaPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Lesser Mana Seeds");
      Tooltip.SetDefault("");
    }
