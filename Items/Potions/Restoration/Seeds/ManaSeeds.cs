...
{
	public class ManaSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.ManaPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Mana Seeds");
      Tooltip.SetDefault("");
    }
