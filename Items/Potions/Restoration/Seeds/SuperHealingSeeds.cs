...
{
	public class SuperHealingSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.SuperHealingPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Super Healing Seeds");
      Tooltip.SetDefault("");
    }
