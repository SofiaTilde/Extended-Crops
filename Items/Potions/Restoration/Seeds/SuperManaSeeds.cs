...
{
	public class SuperManaSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.SuperManaPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Super Mana Seeds");
      Tooltip.SetDefault("");
    }
