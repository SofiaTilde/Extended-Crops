...
{
	public class LesserRestorationSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.LesserRestorationPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Lesser Restoration Seeds");
      Tooltip.SetDefault("");
    }
