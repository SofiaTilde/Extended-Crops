...
{
	public class RestorationSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.RestorationPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Restoration Seeds");
      Tooltip.SetDefault("");
    }
