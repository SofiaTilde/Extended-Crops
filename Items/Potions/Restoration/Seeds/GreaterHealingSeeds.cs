...
{
	public class GreaterHealingSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.GreaterHealingPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Greater Healing Seeds");
      Tooltip.SetDefault("");
    }
