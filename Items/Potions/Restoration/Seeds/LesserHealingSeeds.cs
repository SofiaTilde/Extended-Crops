...
{
	public class LesserHealingSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Potions.Restoration.LesserHealingPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Lesser Healing Seeds");
      Tooltip.SetDefault("");
    }
