...
{
	public class BLeadSeedProcessor : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.value = 150;
			item.createTile = mod.TileType("BLeadSeedProcessor");
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Lead Seed Processor");
      Tooltip.SetDefault("Used to craft seeds");
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "BLeadDust", 10);
