...
{
	public class JMythrilSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.JMythrilPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Mythril Seeds");
      Tooltip.SetDefault("");
    }
