...
{
	public class DPlatinumSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.DPlatinumPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Platinum Seeds");
      Tooltip.SetDefault("");
    }
