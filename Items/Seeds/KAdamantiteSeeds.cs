...
{
	public class KAdamantiteSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.KAdamantitePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Adamantite Seeds");
      Tooltip.SetDefault("");
    }
