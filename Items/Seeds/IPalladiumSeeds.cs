...
{
	public class IPalladiumSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.IPalladiumPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Palladium Seeds");
      Tooltip.SetDefault("");
    }
