...
{
	public class FDemoniteSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.FDemonitePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Demonite Seeds");
      Tooltip.SetDefault("");
    }
