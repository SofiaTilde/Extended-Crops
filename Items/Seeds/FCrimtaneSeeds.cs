...
{
	public class FCrimtaneSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.FCrimtanePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Crimtane Seeds");
      Tooltip.SetDefault("");
    }
