...
{
	public class JOrichalcumSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.JOrichalcumPlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Orichalcum Seeds");
      Tooltip.SetDefault("");
    }
