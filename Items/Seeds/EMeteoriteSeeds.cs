...
{
	public class EMeteoriteSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.EMeteoritePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Meteorite Seeds");
      Tooltip.SetDefault("");
    }
