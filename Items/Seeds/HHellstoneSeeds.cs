...
{
	public class HHellstoneSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Plants.HHellstonePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Hellstone Seeds");
      Tooltip.SetDefault("");
    }
