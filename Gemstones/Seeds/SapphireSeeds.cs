...
namespace ExtendedCrops.Items.Gemstones.Seeds
{
	public class SapphireSeeds : ModItem
	{
		public override void SetDefaults()
		{
			...
			item.height = 14;
			item.value = 80;
			item.createTile = mod.TileType<Tiles.Gemstones.SapphirePlant>();
		}

    public override void SetStaticDefaults()
    {
      DisplayName.SetDefault("Sapphire Seeds");
      Tooltip.SetDefault("");
    }
